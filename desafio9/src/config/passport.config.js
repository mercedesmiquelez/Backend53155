...
const cookieExtracto = (req) => {
  ...
  if (req && req.cookies) {
    //verificamos que haya una request y que verifique si en la request hay una cookie
...
const initializePassport = () => {
  ...
  passport.use(
    ...
    new GoogleStrategy(
      {
        clientID:
          "783463655832-4odjck250gfuv82dvfhg4me0p6vikuu6.apps.googleusercontent.com",
        clientSecret: "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",
